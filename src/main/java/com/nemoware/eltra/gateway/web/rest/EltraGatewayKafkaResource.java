...
@RestController
@RequestMapping("/api/eltra-gateway-kafka")
public class EltraGatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EltraGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public EltraGatewayKafkaResource(KafkaProperties kafkaProperties) {
